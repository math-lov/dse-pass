     ...
     "solution": {
      "steps": [
       ...
       },
       {
        ...
        "zh": "四項要用併項分組。看見後三項 $-15x^{2}-xy+2y^{2}$ 正好是 (a) 的相反數，所以把負號提出來並加括號：變成 $-(15x^{2}+xy-2y^{2})$。很多同學在這裡忘了加括號，之後就無法用 (a) 的結果。",
        "highlight": [
         "(9x-3y)-(15x^{2}+xy-2y^{2})"
        ]
       },
     ...
     },
     {
      ...
      "solution": {
       ...
       "traps": [
        ...
        {
         "opt": "D",
         "zh": "$(2m+8)(m-4)$ 展開得 $2m^{2}-16$，與原式 $2m^{2}-32$ 不符，常數項錯了。"
        }
       ],
       "tip": {
    ...
    [
     {
      ...
      "solution": {
       ...
       "traps": [
        {
         "opt": "B",
         "zh": "$(8c+d+2)(2c+d-2)$ 是兩個括號的常數符號對調：加號那組應是 $-2$（因為 $b=3c-2$），減號那組應是 $+2$。"
        },
        {
         "opt": "C",
